...
# Tên duy nhất trong Hub của bạn (gắn mã học viên để tránh trùng)
...
SYSTEM_V1 = (
    ...
    "Nếu context không chứa thông tin, hãy nói thẳng là bạn không biết.\n\n"
    "Context:\n{context}"
)
...
SYSTEM_V2 = (
    "Bạn là chuyên gia phân tích thông tin. Đọc kỹ context, xác định các facts "
    "liên quan, rồi viết câu trả lời rõ ràng và có cấu trúc (3-5 câu): "
    "nêu ý chính trước, sau đó bổ sung chi tiết hỗ trợ từ context. "
